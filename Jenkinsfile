        ...
        stage('Deploy to AWS EC2'){
            ...
            steps{
                withCredentials([aws(accessKeyVariable: 'AWS_ACCESS_KEY_ID', credentialsId: 'pisproject-aws', secretKeyVariable: 'AWS_SECRET_ACCESS_KEY')]) {
                    ...
                    sh 'sudo docker-machine create --driver generic --generic-ip-address=44.212.197.238 --generic-ssh-key /home/pkosmala/.docker/machine/machines/pisproject/id_rsa --generic-ssh-user ubuntu pisproject-deploy'
                    sleep 60
